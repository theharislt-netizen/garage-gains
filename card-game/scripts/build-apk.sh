...
if [[ ! -f android/app/keystore/palace-release.p12 ]]; then
  echo "Missing release keystore at android/app/keystore/palace-release.p12" >&2
  exit 1
fi
